...
const UUID = process.env.UUID || '53047485-90ce-4b7c-8df2-5f94a18d9868'; //若需要改UUID，需要在config.json里一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'hug.tttmx.ip-ddns.com';                       // 仅能使用token，argo端口8080，cf后台设置需对应
